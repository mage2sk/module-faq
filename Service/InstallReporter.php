<?php
/**
 * Standalone install + heartbeat reporter for Panth_Faq.
 *
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_Faq';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-faq';
